...
public class BluetoothLePlugin extends CordovaPlugin {
  ...
  //Error Messages
    ...
    public boolean execute(String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
         Log.d("CN1BT", "execute: " + action + " " + args);
    ...
    private synchronized void startScanAction(JSONArray args, CallbackContext callbackContext) {
        ...
        if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            Log.d("CN1BT", "startScan " + scanSettings.build());
    ...
    private void createScanCallback() {
        ...
        scanCallback = new ScanCallback() {
            ...
            public void onBatchScanResults(List<ScanResult> results) {
                Log.d("CN1BT", "onBatchScanResults " + results.toString());
                if (scanCallbackContext == null) {
                    return;
                }
            }
            ...
            public void onScanFailed(int errorCode) {
                Log.d("CN1BT", "onScanFailed " + errorCode);
                synchronized (BluetoothLePlugin.this) {
                    if (scanCallbackContext == null) {
                        return;
                    }
            ...
            public void onScanResult(int callbackType, ScanResult result) {
                Log.d("CN1BT", "onScanResult " + callbackType + " " + result);
                synchronized (BluetoothLePlugin.this) {
                    if (scanCallbackContext == null) {
                        return;
                    }
